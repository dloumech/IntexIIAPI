...
namespace IntexIIAPI
{
    public class BurialData
    {
        ...
        public float material_LinenVeryLooselySpun { get; set; }
        public float material_Other { get; set; }
        public float material_Other_burlap { get; set; }
        public float material_Other_VegetableFiber { get; set; }
        ...
        public Tensor<float> AsTensor()
        {
            float[] data = new float[]
            {
              ...
              ageatdeath_A, ageatdeath_C, ageatdeath_I, ageatdeath_N,
               material_Linen, material_Linen_background, material_Linen_red, material_LinenVeryLooselySpun,
               material_Other, material_Other_burlap, material_Other_VegetableFiber, material_Wool,
